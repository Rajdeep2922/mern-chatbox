      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            ...
            <div className='hidden absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] group-hover:block'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-2 px-4 mt-5'>
          ...
          <input onChange={(e) => setInput(e.target.value)} type="text" className='bg-transparent border-none outline-none text-white-xs placeholder-[#c8c8c8] flex-1' placeholder='Search User....' />
        </div>
      </div>
